...
SLUG = "sme-owner-ai-architect-2026"
TITLE = "30人公司的AI HR：owner当架构师，不是加工具"
CAT = "中小企业 · AI+HR"
...
def draw_grid(d, w, h, seed):
    ...
    for i in range(cols):
        for j in range(rows):
            x = int(w * 0.05 + i * cell_w)
            y = int(h * 0.15 + j * cell_h)
            if rnd.random() > 0.6:
                d.rectangle([x, y, x + int(cell_w*0.7), y + int(cell_h*0.7)],
